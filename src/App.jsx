  ...
  return (
    <div className="flex w-full max-w-96 flex-col items-center gap-4">
      ...
      <div className="flex w-full gap-2">
        <input
          className="w-full border border-gray-600 rouded-md px-2"
          ref={inputAdicionar}
          type="text"
          placeholder="Digite um item"
        />
        <button className="rounded-md bg-gray-800 text-white px-2 cursor-pointer hover:bg-gray-600 transition" onClick={() => adicionarElementoNaLista()}>Adicionar</button>
      </div>
